...
import { encrypt, compare } from '../../services/bcrypt/bcrypt.handle'
import { UserLoginDTO } from './DTO/user.login'
import { type UserRegisterDTO } from './DTO/user.register'
...
export class UserCases {
  ...
  public async createUser(
    ...
    const user = new User(newId, username, email, passwordHash, UserRole.USER, '', 0, TierAccount.FREE)
